...
from .api import now_ms, ensure_dir, load_image_any, DeviceManager, DeviceChoice, VehicleDetector, union_merge_boxes, PostProcessor, ClusterRefiner, draw_annotated
...
def run(image_path: str, out_dir: str, cfg: Dict[str, Any], device_mode: str = "auto", state: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
    ...
    dets, extra = ref.refine(img, dets, cfg, dev)
